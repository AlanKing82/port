...
//						}
			...
			// Creating navigation
			/* Added id's, glyphs from previous slider and appended to control nav */

			if( ls.o.navPrevNext ){

				$('<a class="ls-nav-prev" id="prevslide" href="#" ><i class="font-icon-arrow-simple-left"></a>').click(function(e){
					e.preventDefault();
					$(el).layerSlider('prev');
					$(el).find('#prevslide').layerSlider('prev');
				}).appendTo($(el).find('.control-nav')); // amendment

				$('<a class="ls-nav-next" id="nextslide" href="#" ><i class="font-icon-arrow-simple-right"></i></a>').click(function(e){
					e.preventDefault();
					$(el).layerSlider('next');
				}).appendTo($(el).find('.control-nav'));
			...
			if( ls.o.navStartStop || ls.o.navButtons ){
                ...
                var bottomNav = $('<div class="ls-bottom-nav-wrapper" />').appendTo( $(el).find('.control-nav') );
